...
namespace Sistema.Web.Controllers.Wcm
{
    ...
    public class SucesosController : ControllerBase
    {
        ...
        // GET: api/Suceso/ListarSucesos
        [HttpGet("[action]")]
        public async Task<IEnumerable<SelectViewModel>> ListarSucesos()
        {
            var suceso = await _context.Sucesos
                .Where(a => a.activo == true)
                .ToListAsync();

            return suceso.Select(c => new SelectViewModel
            {
                idsuceso = c.idsuceso,
                nombre = c.nombre,
        ...
        public async Task<IActionResult> Actualizar([FromBody] ActualizarViewModel model)
        {
            ...
            var categoria = await _context.Sucesos.FirstOrDefaultAsync(c => c.idsuceso == model.idsuceso);
        ...
        public async Task<IActionResult> Desactivar([FromRoute] int id)
        {
            ...
            var suceso = await _context.Sucesos.FirstOrDefaultAsync(c => c.idsuceso == id);
        ...
        public async Task<IActionResult> Activar([FromRoute] int id)
        {
            ...
            var area = await _context.Sucesos.FirstOrDefaultAsync(c => c.idsuceso == id);
